                    ...
                    return (
                        <li key={i} className="flex justify-between mb-2">
                            <div className="flex items-center">
                                <span
                                    className={
                                        ' relative mr-2 h-4 w-4 rounded-full border-2 border-slate-700 ' +
                                        `after:absolute after:left-[50%] after:bottom-[100%] after:-z-10 after:block after:h-[20px] after:w-[5px] after:-translate-x-1/2 after:bg-black after:opacity-50 after:content-[''] ` +
                                        (i == 0 &&
                                            'border-4 border-slate-700 after:hidden')
                                    }
                                />
                                <p>{state}</p>
                            </div>
